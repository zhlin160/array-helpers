...
class BaseArrayHelper
{
     ...
     * @throws \BadMethodCallException if the $direction or $sortFlag parameters do not have
    ...
    public static function multisort(&$array, $key, $direction = SORT_ASC, $sortFlag = SORT_REGULAR)
    {
        ...
        if (is_scalar($direction)) {
            ...
            throw new \BadMethodCallException('The length of $direction parameter must be the same as that of $keys.');
        }
        if (is_scalar($sortFlag)) {
            $sortFlag = array_fill(0, $n, $sortFlag);
        } elseif (count($sortFlag) !== $n) {
            throw new \BadMethodCallException('The length of $sortFlag parameter must be the same as that of $keys.');
        }
        $args = [];
     ...
     * @throws \BadMethodCallException if `$haystack` is neither traversable nor an array.
    ...
    public static function isIn($needle, $haystack, $strict = false)
    {
        if ($haystack instanceof \Traversable) {
            ...
            throw new \BadMethodCallException('Argument $haystack must be an array or implement Traversable');
        }
     ...
     * @param bool $strict Whether to enable strict (`===`) comparison.
     * @throws \BadMethodCallException if `$haystack` or `$needles` is neither traversable nor an array.
    ...
    public static function isSubset($needles, $haystack, $strict = false)
    {
        ...
        throw new \BadMethodCallException('Argument $needles must be an array or implement Traversable');
    }
